 ...
 */
final class Version20210925171943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE peinture CHANGE largeur largeur NUMERIC(6, 2) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE peinture CHANGE largeur largeur NUMERIC(6, 2) NOT NULL');
    }
}
